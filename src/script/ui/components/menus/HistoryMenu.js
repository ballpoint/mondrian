  ...
  render() {
    return (
      <MenuBody absoluteTop={this.props.absoluteTop} absoluteLeft={this.props.absoluteLeft}>
        <MenuItem label="Undo" disabled={false} action={this.props.editor.undo.bind(this.props.editor)} />
        <MenuItem label="Redo" disabled={false} action={this.props.editor.redo.bind(this.props.editor)} />
      </MenuBody>
    );
  }
});
